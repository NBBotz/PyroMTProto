...
class Markdown:
    ...
    def unparse(text: str, entities: list):
        ...
        delimiters = {
            ...
            MessageEntityType.DIFF_TYPE_INSERT: DIFF_INSERT_DELIM,
            MessageEntityType.DIFF_TYPE_DELETE: DIFF_DELETE_DELIM,
            MessageEntityType.DIFF_TYPE_REPLACE: DIFF_REPLACE_DELIM,
        }

        # Asymmetric delimiters (open ≠ close)
        asymmetric_delims = {
            DIFF_INSERT_DELIM: DIFF_INSERT_END_DELIM,
            DIFF_DELETE_DELIM: DIFF_DELETE_END_DELIM,
            DIFF_REPLACE_DELIM: DIFF_REPLACE_END_DELIM,
        }
