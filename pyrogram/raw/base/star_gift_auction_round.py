...
if TYPE_CHECKING:
    ...
    class StarGiftAuctionRound(metaclass=BaseTypeMeta):  # type: ignore
    ...
    Constructors:
        ...
        def __init__(self):
            raise TypeError(
                ...
                "More info: https://telegramplayground.github.io/pyrogram/telegram/base/star-gift-auction-round"
            )
