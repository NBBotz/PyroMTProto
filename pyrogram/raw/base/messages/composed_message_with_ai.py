...
if TYPE_CHECKING:
    ...
    class ComposedMessageWithAI(metaclass=BaseTypeMeta):  # type: ignore
    ...
    Functions:
        ...
        def __init__(self):
            raise TypeError(
                ...
                "More info: https://telegramplayground.github.io/pyrogram/telegram/base/composed-message-with-ai"
            )
