...
if TYPE_CHECKING:
    ...
    class InputPasskeyResponse(metaclass=BaseTypeMeta):  # type: ignore
    ...
    Constructors:
        ...
        def __init__(self):
            raise TypeError(
                ...
                "More info: https://telegramplayground.github.io/pyrogram/telegram/base/input-passkey-response"
            )
