...
if TYPE_CHECKING:
    ...
    class StarGiftAuctionState(metaclass=BaseTypeMeta):  # type: ignore
    ...
    Constructors:
        ...
        def __init__(self):
            raise TypeError(
                ...
                "More info: https://telegramplayground.github.io/pyrogram/telegram/base/star-gift-auction-state"
            )
