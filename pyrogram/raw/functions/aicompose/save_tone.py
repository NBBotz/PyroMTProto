...
class SaveTone(TLObject["raw.base.Bool"]):
    ...
    __slots__: list[str] = ["tone", "unsave"]

    ID = 0x1782cbb1
    QUALNAME = "functions.aicompose.SaveTone"

    def __init__(self, *, tone: "raw.base.InputAiComposeTone", unsave: bool) -> None:
        self.tone = tone  # InputAiComposeTone
        self.unsave = unsave  # Bool

    @staticmethod
    def read(b: BytesIO, *args: Any) -> "SaveTone":
        # No flags
        ...
        return SaveTone(tone=tone, unsave=unsave)
