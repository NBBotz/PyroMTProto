...
class ReadPollVotes(TLObject["raw.base.messages.AffectedHistory"]):
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "ReadPollVotes":
        ...
        return ReadPollVotes(peer=peer, top_msg_id=top_msg_id)
