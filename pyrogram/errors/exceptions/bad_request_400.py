...
class BirthdayAlready(BadRequest):
    """The user has already entered a birthday."""
    ID = "BIRTHDAY_ALREADY"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
...
class EffectChatInvalid(BadRequest):
    """The effect_id can only be used in private chats"""
...
class EmailInstallMissing(BadRequest):
    """In order to use account.SendVerifyEmailCode, auth.SendCode must return auth.SentCodeTypeSetUpEmailRequired."""
...
class ExtendedMediaEmpty(BadRequest):
    """The specified paid media is empty."""
...
class FileReferenceEmpty(BadRequest):
    """The file reference of the media file at index {value} in the passed media array is empty."""
...
class InputStarsAmountInvalid(BadRequest):
    """The specified star_count is invalid."""
...
class InputStarsNanosInvalid(BadRequest):
    """The specified nanostar_count is invalid."""
...
class PinnedTopicNotModified(BadRequest):
    """The specified pinned topic was not modified."""
...
class ResellStarsTooFew(BadRequest):
    """The resell_stars is less than the minimum amount required."""
...
class ResellStarsTooMuch(BadRequest):
    """The resell_stars is more than the maximum amount allowed."""
...
class StargiftAlreadyTransferred(BadRequest):
    """The provided star gift was already transferred."""
...
class StargiftAttributeInvalid(BadRequest):
    """The provided star gift attribute is invalid."""
...
class StargiftMessageInvalid(BadRequest):
    """The provided star gift message is invalid. You cannot specify it in a message if the recepient has specified send_paid_messages_stars."""
...
class StargiftOfferInvalid(BadRequest):
    """The star gift offer is invalid."""
...
class StargiftOfferNotAllowed(BadRequest):
    """The star gift offer is not allowed."""
